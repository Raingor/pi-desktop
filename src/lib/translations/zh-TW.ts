...
const zhTW: Record<string, string> = {
  ...
  "chat.usage_cost": "成本",
  "chat.usage_compact": "壓縮工作階段",
  "chat.usage_compact_hint": "把較早的對話總結成摘要，釋放上下文空間",
  "chat.usage_compact_confirm": "壓縮會呼叫一次模型來產生摘要，會產生費用並可能耗時數分鐘。繼續？",
  "chat.usage_compact_running": "正在壓縮…",
  "chat.usage_compact_done": "已壓縮：{0} → {1}",
  "chat.usage_compact_cost": "本次摘要花費 ${0}",
  "chat.usage_compact_instructions": "可選：讓摘要側重什麼（例如「側重程式碼改動」）",
  "chat.usage_compact_start": "開始壓縮",
  "chat.usage_compact_cancel": "取消",
  "chat.usage_compact_too_small": "工作階段內容還不夠多，暫時無需壓縮",
  "chat.usage_compact_failed": "壓縮失敗：{0}",
