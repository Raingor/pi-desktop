...
const ja: Record<string, string> = {
  ...
  "chat.usage_cost": "コスト",
  "chat.usage_compact": "セッションを圧縮",
  "chat.usage_compact_hint": "古いやり取りを要約してコンテキストを解放します",
  "chat.usage_compact_confirm": "圧縮は要約のためにモデルを 1 回呼び出します。課金が発生し、数分かかることがあります。続けますか？",
  "chat.usage_compact_running": "圧縮中…",
  "chat.usage_compact_done": "圧縮しました：{0} → {1}",
  "chat.usage_compact_cost": "要約のコスト ${0}",
  "chat.usage_compact_instructions": "任意：要約で重視する点",
  "chat.usage_compact_start": "圧縮する",
  "chat.usage_compact_cancel": "キャンセル",
  "chat.usage_compact_too_small": "圧縮するにはまだ会話が足りません",
  "chat.usage_compact_failed": "圧縮に失敗しました：{0}",
