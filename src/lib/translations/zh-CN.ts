...
const zhCN: Record<string, string> = {
  ...
  "chat.usage_cost": "成本",
  "chat.usage_compact": "压缩会话",
  "chat.usage_compact_hint": "把较早的对话总结成摘要，释放上下文空间",
  "chat.usage_compact_confirm": "压缩会调用一次模型来生成摘要，会产生费用并可能耗时数分钟。继续？",
  "chat.usage_compact_running": "正在压缩…",
  "chat.usage_compact_done": "已压缩：{0} → {1}",
  "chat.usage_compact_cost": "本次摘要花费 ${0}",
  "chat.usage_compact_instructions": "可选：让摘要侧重什么（例如「侧重代码改动」）",
  "chat.usage_compact_start": "开始压缩",
  "chat.usage_compact_cancel": "取消",
  "chat.usage_compact_too_small": "会话内容还不够多，暂时无需压缩",
  "chat.usage_compact_failed": "压缩失败：{0}",
