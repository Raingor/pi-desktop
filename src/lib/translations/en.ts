...
const en: Record<string, string> = {
  ...
  "chat.usage_compact": "Compact session",
  "chat.usage_compact_hint": "Summarize older turns to free up context",
  "chat.usage_compact_confirm": "Compaction calls the model once to write a summary. It is billed and can take minutes. Continue?",
  "chat.usage_compact_running": "Compacting…",
  "chat.usage_compact_done": "Compacted: {0} → {1}",
  "chat.usage_compact_cost": "Summary cost ${0}",
  "chat.usage_compact_instructions": "Optional: what the summary should focus on",
  "chat.usage_compact_start": "Compact",
  "chat.usage_compact_cancel": "Cancel",
  "chat.usage_compact_too_small": "Not enough conversation to compact yet",
  "chat.usage_compact_failed": "Compaction failed: {0}",
